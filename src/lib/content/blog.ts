...
export const POSTS: BlogPost[] = [
  {
    slug: "marg-erp-vs-vyapar-distributors",
    title: "Marg ERP vs Vyapar (2026): Which Should a Distributor Actually Buy?",
    description:
    ...
    readMins: 9,
    cover: 4,
    image: "/post-marg-vyapar.webp",
    tags: ["Marg ERP", "Vyapar", "distribution software", "buyer's guide"],
    vertical: "distribution",
    body: [
      { t: "p", x: "If you run a distribution or wholesale business and ask around for software, you'll hear two names for two very different reasons. Marg ERP is what the pharma distributor two lanes down has run since 2014 — dense, powerful, built for exactly your trade. Vyapar is what the YouTube ad shows — a friendly billing app on a phone, priced like a recharge pack. One was built for your business but not for you; the other was built for you but maybe not for your business. This comparison untangles that." },
      { t: "p", x: "Full disclosure, same as [our Tally vs Vyapar comparison](/blog/tally-vs-vyapar-comparison-india): we build Vrikso, a cloud platform for distributors, so we compete with both. Everything below sticks to verifiable facts, and we'll tell you plainly where each tool beats us." },
      { t: "callout", x: "The 30-second answer: if you're a pharma or FMCG distributor who needs batch/expiry tracking, company schemes and a trained operator is available — Marg is the specialist and Vyapar isn't in the contest. If you're a small trader billing for yourself from a phone, Vyapar wins on simplicity. But get a written price quote from your Marg dealer before deciding anything — because Marg's real cost isn't on its website. And if your salesmen take orders in the market while billing happens at the godown, read to the end: both options may be the wrong shape." },
      { t: "h2", x: "What they cost in 2026 — and why Marg's price is the first surprise" },
      { t: "p", x: "Vyapar publishes its prices. Marg doesn't — it sells through a dealer network, and dealers set their own price for licence, installation, training and the annual maintenance contract. The same edition can quote ₹15,000 in one city and ₹18,000 in the next. The list prices you can triangulate for 2026:" },
      { t: "table",
        head: ["", "Marg ERP 9+", "Vyapar"],
        rows: [
          ["Licence", "Basic ≈ ₹7,200 · Silver ≈ ₹12,600 · Gold (unlimited users, one LAN) ≈ ₹25,200 — all + 18% GST, negotiated via dealer", "Free basic tier; paid plans billed yearly (roughly ₹300–₹400/month equivalent)"],
          ["Yearly cost after year 1", "AMC ≈ ₹2,000–₹5,000 depending on edition and dealer", "Plan renewal"],
          ["Extras that surprise buyers", "Dealer charges for installation/training; add-ons and customisation billed separately", "Higher tiers for desktop + sync"],
        ...
        cap: "Rule of thumb: a typical single-godown distributor on Marg Silver lands around ₹16,000 in year one and ₹3,500/year after — if the dealer quote is fair. Always get the quote in writing with AMC and training itemised." },
      ...
      { t: "h2", x: "Where Marg genuinely wins" },
      { t: "ul", items: [
      ...
      { t: "h2", x: "Head-to-head for a distribution business" },
      { t: "table",
        head: ["Dimension", "Marg ERP 9+", "Vyapar"],
        rows: [
          ["Schemes (10+1, slabs)", "Native", "Basic discounts only"],
          ["Batch & expiry tracking", "Native, pharma-grade", "Limited"],
          ["Salesman / beat management", "Yes (desktop-centric)", "No real concept of it"],
          ["Learning curve", "Steep — assumes a trained operator", "Gentle — built for the owner"],
          ["Mobile order-taking in the market", "Add-on apps, still desktop-first", "Phone billing, but no field-sales workflow"],
          ["Multi-user", "Gold edition, one office LAN", "Per-device with sync"],
          ["Price transparency", "Dealer-quoted, negotiable", "Published"],
          ["Support", "Local dealer (quality varies)", "App/chat support"],
          ["Best-fit user", "Established distributor with an operator", "Owner-operated small trader"],
        ],
        cap: "The mismatch — and the wasted money — happens when a growing distributor buys the simple tool and outgrows it in a year, or a small trader buys the specialist tool and uses 10% of it." },
      { t: "h2", x: "The question that actually decides it: who operates, and where?" },
      { t: "p", x: "Strip away the feature lists and ask two things. First: who will sit at the keyboard daily? If the answer is 'a trained operator or accountant', Marg's depth is usable. If the answer is 'me, between customers', Marg's depth is a tax and Vyapar's simplicity is the feature." },
      { t: "p", x: "Second: where does your business happen? If everything happens at one counter, a desktop or single phone is fine. But distribution usually happens in three places at once — the salesman in the market taking orders, the godown packing, the counter billing. Both Marg and Vyapar were architected for one machine; distribution is a team sport. That's not a missing feature, it's a shape mismatch — we listed the [signs desktop software is holding you back](/blog/signs-desktop-billing-software-holding-you-back) if you want the symptoms checklist." },
      { t: "h2", x: "The third option: cloud, built for the team" },
      { t: "p", x: "This is where we talk our own book, plainly. [Vrikso](/distribution) was built for exactly the gap above: nothing to install, so your phone, every salesman's phone and the godown tablet run on the same live data. Field orders flow to the warehouse for picking, invoices with [e-way bills](/blog/e-way-bills-for-distributors) and GST reports come from the same system, outstanding and credit limits update in real time, and invoices go to retailers on WhatsApp automatically. Pricing is published like a menu — [₹0 to start, ₹299/month, ₹799/month for a team of ten](/pricing) — no dealer, no AMC, no 'contact sales'." },
      { t: "p", x: "Where we lose honestly: we need internet; Marg's pharma-specific depth (substitutes, expiry-first picking) is ahead of us; and Marg has two decades of trust we're still earning. Where we win: the moment your business is a team across market, godown and counter — because that's the shape we were built for, and the shape neither desktop licence can become." },
      ...
      { t: "ul", items: [
        ...
        "FMCG distributor whose salesmen work the market while the godown bills → look at cloud platforms before buying any per-PC licence. Use our [7-point checklist for choosing distribution software](/blog/choosing-distribution-software-india) — and [try Vrikso free](/distribution) with your own products and routes; the trial costs an afternoon.",
        "Just starting out as a distributor? Software is the smallest line in your setup budget — get the [full cost and margin picture](/blog/become-fmcg-distributor-india-cost-margin) first.",
      ] },
      { t: "h2", x: "Frequently asked questions" },
      { t: "faq", items: [
        { q: "Is Marg ERP better than Vyapar for distributors?", a: "For distribution-specific work — schemes, batch/expiry, salesman-wise reports — yes, clearly. Vyapar is a general billing app. The trade-off is that Marg assumes a trained operator and a Windows PC; Vyapar assumes an owner with a phone." },
        { q: "What does Marg ERP actually cost in 2026?", a: "List prices run roughly ₹7,200 (Basic), ₹12,600 (Silver) and ₹25,200 (Gold, unlimited users on one office network), plus 18% GST — but Marg sells through dealers who set their own final price and charge separately for installation, training and AMC (₹2,000–₹5,000/year). Always get an itemised written quote." },
        { q: "Is Vyapar good for a wholesale business?", a: "For a small owner-operated wholesale counter, yes — billing, basic stock and GST reports from a phone. It has no real concept of schemes, beats, salesman apps or credit-limit workflows, so growing distributors tend to outgrow it." },
        { q: "Can Marg ERP work on mobile?", a: "Marg is Windows desktop software at its core. Companion mobile apps exist for ordering and reports, but the system of record stays on the office PC, and the workflow assumes someone is sitting at it." },
        { q: "Which is better for GST filing?", a: "Both produce GSTR-1-friendly data; Marg goes deeper on returns workflows and is better known to accountants. Either way, filing is only as clean as your invoicing discipline — see our [GSTR-1 guide for distributors](/blog/gstr1-filing-made-simple)." },
        { q: "What's the best alternative to Marg ERP?", a: "Depends on why you're leaving. If Marg is too complex, Vyapar. If it's too desk-bound for a team across market and godown, a cloud distribution platform like [Vrikso](/distribution), where every device shares one live system and pricing is published." },
      ] },
      { t: "p", x: "Buy the tool that matches who operates it and where your work happens — not the one with the loudest ad or the most familiar name. If that's Marg, negotiate hard and insist on a written quote. If it's Vyapar, start free today. And if your business is a team spread across market, godown and counter, [see what distribution feels like on one live system](/distribution) — the free plan is a real product, and switching costs an afternoon, not a dealer visit." },
    ],
  },
  {
    slug: "recover-udhaar-pending-payments-india",
    title: "How to Recover Udhaar and Pending Payments: Scripts, Templates & Legal Options (2026)",
    description:
      "Money stuck with customers? Copy-paste WhatsApp payment reminder templates (Hindi + English), a 4-step escalation ladder, and the real legal options — MSME Samadhaan, legal notice, cheque bounce — explained simply.",
    category: "Cash Flow",
    author: "Vrikso Team",
    date: "2026-08-10",
    readMins: 10,
    cover: 1,
    image: "/post-udhaar-recovery.webp",
    tags: ["udhaar", "collections", "payment reminder", "cash flow"],
    vertical: "distribution",
    body: [
      { t: "p", x: "Every trade business in India carries a number it doesn't like to say out loud: the udhaar. Money for goods already delivered, sitting in someone else's pocket — a retailer who says 'agle hafte pakka', a regular customer whose khata crossed ₹4,000 months ago, a client whose invoice is 90 days old. On paper you're profitable. In the bank, you're tight." },
      ...
      { t: "p", x: "This guide is the complete recovery ladder: exact messages to send (copy them), when to escalate, and what your legal options actually are in 2026 — including the one that awards you 16%+ compound interest and costs nothing to file." },
      { t: "h2", x: "First, one rule that changes everything" },
      { t: "p", x: "Never make the ask personal. Make it procedural. 'Bhaiya, kuch paise de do' is a favour. 'Your outstanding is ₹12,450, here's the statement, which date should I note for payment?' is a process. The first invites negotiation and awkwardness; the second invites a date. Every script below follows this rule: specific amount, written record, specific next step." },
      { t: "p", x: "That also means: before you send anything, know the exact figure per customer — every invoice, every part-payment, current as of today. If your khata is a notebook or your billing is on one shop PC, this is the step where recovery usually dies. (We wrote separately about [building a system that prevents outstanding from piling up](/blog/cut-outstanding-collect-faster) — this article is about recovering what's already stuck.)" },
      { t: "h2", x: "Step 1 — The statement (Day 1): friendly, factual, written" },
      { t: "p", x: "Send the balance on WhatsApp — not a demand, just the fact. WhatsApp matters for three reasons: it's read within minutes, the tick is your delivery proof, and it creates a written trail you may need later. Copy this:" },
      { t: "quote", x: "Namaste ji 🙏 Sharing your account statement from [Shop/Firm Name]: Total outstanding ₹12,450 (3 bills, oldest dated 14 June). Statement attached. Please check and tell me a convenient date for payment. UPI: [number]. Thank you!" },
      { t: "quote", x: "Namaste ji 🙏 [Firm Name] ka hisaab bhej rahe hain: kul baaki ₹12,450 (3 bill, sabse purana 14 June ka). Statement attached hai. Check karke bata dijiye payment kis din tak ho payegi. UPI: [number]. Dhanyavaad!" },
      { t: "p", x: "Notice what this does: it asks for a date, not money. A date is easy to give — and once given, it's theirs to keep." },
      { t: "h2", x: "Step 2 — The date-keeper (their promised date, or Day 7)" },
      { t: "p", x: "If they gave a date, message on the morning of that date — not after it passes. If they didn't reply at all, follow up on day 7:" },
      { t: "quote", x: "Namaste ji, reminder as discussed — payment of ₹12,450 due today. UPI [number] ya cash, jo aasan ho. Receipt turant bhej denge. 🙏" },
      { t: "p", x: "If the date slips, don't lecture. Re-anchor once — 'Koi baat nahi ji. Kal ka pakka rahe? Main kal subah yaad dila dunga.' — then actually message tomorrow morning. Consistency is the whole trick: the customer must learn that your reminders arrive on schedule, every time, without anger. Most people pay simply to make reliable reminders stop." },
      { t: "h2", x: "Step 3 — The freeze (Day 30–45): consequence without conflict" },
      { t: "p", x: "If two promised dates have passed, the relationship needs a boundary, delivered respectfully and in writing:" },
      { t: "quote", x: "Namaste ji. Aapka account ₹12,450 par 45 din se pending hai. Naye maal ke liye humein pehle purana hisaab clear karna hoga — company policy hai. Aaj ₹5,000 bhi kar dein to naya order aaj hi nikal denge. 🙏" },
      { t: "p", x: "Three things are happening here: stop new credit (never throw good money after bad), blame the policy, not the person ('company policy' lets both sides save face), and offer a part-payment path — ₹5,000 today genuinely beats ₹12,450 never. For distributors, this is also where a credit limit that automatically blocks the next order earns its keep: the software becomes the bad guy, and your salesman stays the friend." },
      { t: "h2", x: "Step 4 — The formal stage (Day 60+): paper, not phone calls" },
      { t: "p", x: "Past 60 days, verbal follow-up has diminishing returns. Now you escalate on paper — and in India you have real options that most small businesses never use." },
      { t: "table",
        head: ["Option", "Best for", "Cost", "Teeth"],
        rows: [
      ...
      { t: "h2", x: "What actually determines whether you get paid" },
      { t: "ul", items: [
      ...
      { t: "p", x: "This is, honestly, the part where software earns its fee. [Vrikso](/distribution) keeps a live ledger per customer, groups outstanding into aging buckets (0–30, 31–60, 61–90, 90+ days), and sends the invoice and balance [on WhatsApp automatically](/blog/whatsapp-for-distribution-business) — so Step 1 and Step 2 of the ladder happen without you typing a word, for every customer, every time. Plans start at [₹0, with paid tiers at ₹299 and ₹799/month](/pricing) — less than the interest lost on one stuck bill." },
      { t: "shot", name: "aging", cap: "The aging report — your udhaar sorted by how long it's been sleeping. Chase the 90+ column first, every week." },
      { t: "h2", x: "Frequently asked questions" },
      { t: "faq", items: [
        { q: "How do I ask for pending payment without spoiling the relationship?", a: "Send a written statement with the exact amount and ask for a date, not the money: 'Please check and tell me a convenient date.' Specific, factual, and face-saving — the ask feels like accounting, not accusation." },
        { q: "Can I recover udhaar if I have no written agreement?", a: "Yes. Courts and councils accept invoices, delivery challans, khata entries, and WhatsApp chats as evidence of a running account. A customer's message acknowledging the balance is particularly strong — get the amount confirmed in writing whenever you can." },
        { q: "What is the time limit for recovering money legally in India?", a: "Three years from the date the payment became due. A written acknowledgement of the debt (including on WhatsApp) restarts the three-year clock from that date." },
        { q: "What is MSME Samadhaan and who can use it?", a: "A government portal (samadhaan.msme.gov.in) where Udyam-registered micro and small enterprises file complaints against buyers who haven't paid within 45 days. The buyer owes compound interest at 3× the RBI bank rate, and the state Facilitation Council targets disposal within 90 days. No lawyer or court fee is needed to file." },
        { q: "Are WhatsApp payment reminders legally valid?", a: "Yes — WhatsApp messages are admissible as electronic evidence and create a dated trail of demands and acknowledgements. Keep the thread professional; it may become your annexure." },
        { q: "How much does a legal notice for payment recovery cost?", a: "Typically ₹1,500–₹3,000 through a local advocate. It's often the highest-ROI step in the ladder: many disputes settle within the 15-day notice window." },
        { q: "What can I do about a bounced cheque in 2026?", a: "Act fast: written demand within 30 days of the return memo, 15 days for the drawer to pay, then a criminal complaint under Section 138 NI Act within 30 more days. Miss the timelines and the criminal remedy lapses — though a civil claim survives." },
        { q: "How do I stop udhaar from piling up again?", a: "Credit limits enforced by software (the next order blocks automatically), a weekly 15-minute review of the 90+ day aging bucket, and automatic WhatsApp statements. We covered the [full prevention system here](/blog/cut-outstanding-collect-faster)." },
      ] },
      { t: "p", x: "Udhaar is not a moral failure — yours or your customer's. It's a process failure, and processes can be fixed this week: send the statements today, put dates against every balance, freeze credit past 45 days, and let paper do the talking past 60. And if you'd rather a system ran the first two rungs for you across every customer automatically, [try Vrikso free](/distribution) — your aging report will tell you within a day exactly where your money is sleeping." },
    ],
  },
  {
